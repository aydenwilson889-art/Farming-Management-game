...
import { DollarSign, Utensils, Scale, CheckCircle, XCircle, ArrowRight } from 'lucide-react';
...
const AnimalFeeding: React.FC<AnimalFeedingProps> = ({ meatAnimals, cash, onFeedAnimal, onButcherAnimal }) => {
  ...
  const renderWeightStatus = (animal: Animal) => {
    ...
    const weightDiff = Math.abs(animal.weight - animal.optimalWeight);
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center space-x-2">
                  ...
                  >
                    ...
                    {isReadyToButcher ? 'Butcher All' : `${animal.daysUntilProduction - 1} Days Left`}
                  </Button>
                </div>
              </div>
            );
